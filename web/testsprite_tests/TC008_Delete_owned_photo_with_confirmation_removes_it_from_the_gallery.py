...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Entrar a la galería' button so the SPA router transitions to the gallery (/home). Then prepare to intercept/mock the photos GET request before the gallery tiles render.
